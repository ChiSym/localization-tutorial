...
#
# The resulting algorithm is conventionally called "MCMC rejuvenation", and our strategy to resample between the pair amounts to the "Boltzmann acceptance rule".  A even more common acceptance rule that slightly favors the jiggled sample is called the "Metropolis–Hastings acceptance rule".
